(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://russomi-labs.github.io/off/';function updateStaticCache(){const urls=['https://russomi-labs.github.io/','https://russomi-labs.github.io/manifest.json','/acme-corporation/css/index.min.18c0833777563fc29c577e1474462f9f8bbc30dff7362236622127e6530c1dd69e8a02f8030e1f8213aa3602bc96126ae50c4f886644a38401ba7291cb8cd293.css','/acme-corporation/index.min.js','https://russomi-labs.github.io/acme-corporation/image/background.svg','https://russomi-labs.github.io/acme-corporation/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://russomi-labs.github.io/acme-corporation/image/logo.min.svg','https://russomi-labs.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
